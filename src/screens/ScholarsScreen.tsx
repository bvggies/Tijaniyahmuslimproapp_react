...
const SCHOLARS: Scholar[] = [
  ...
  // 6. Muhammad Hafiz Shinqiti
  {
    ...
    details: [
      ...
      { 
        heading: 'Scholarly Family', 
        text: 'Sidi al-Hafiz was not the only scholar among his siblings, and two brothers, Muhammad Sa\'id and Muhammad al-Amin were also famous scholars. The same was true of his brother-in-law, Muhamdi b. Abd Allah al-Alawi, known as "Baddi," who authored the most complete biography of Sidi al-Hafiz, called Nuzhat al-Mustam\' wa-l-lafiz fi manaqib al-shaykh Muhammad al-Hafiz (1832).',
        frenchText: 'Sidi al-Hafiz n\'était pas le seul savant parmi ses frères et sœurs, et deux frères, Muhammad Sa\'id et Muhammad al-Amin étaient également des savants célèbres. Il en était de même pour son beau-frère, Muhamdi b. Abd Allah al-Alawi, connu sous le nom de "Baddi," qui a écrit la biographie la plus complète de Sidi al-Hafiz, intitulée Nuzhat al-Mustam\' wa-l-lafiz fi manaqib al-shaykh Muhammad al-Hafiz (1832).',
        arabicText: 'لم يكن سيدي الحافظ العالِم الوحيد بين إخوته، وكان شقيقان، محمد سعيد ومحمد الأمين، أيضاً علماء مشهورين. وكان الأمر نفسه صحيحاً بالنسبة لصهره، محمدي بن عبد الله العلوي، المعروف باسم "بدي"، الذي ألف السيرة الذاتية الأكثر اكتمالاً لسيدي الحافظ، بعنوان نزهة المستمع واللافظ في مناقب الشيخ محمد الحافظ (1832).',
        hausaText: 'Sidi al-Hafiz ba shi kaɗai ba ne malami a tsakanin \'yan uwansa, kuma \'yan\'uwa biyu, Muhammad Sa\'id da Muhammad al-Amin su ma fitattun malamai ne. Haka kuma ya kasance ga surukinsa, Muhamdi b. Abd Allah al-Alawi, wanda aka fi sani da "Baddi," wanda ya rubuta cikakken tarihin rayuwar Sidi al-Hafiz, mai suna Nuzhat al-Mustam\' wa-l-lafiz fi manaqib al-shaykh Muhammad al-Hafiz (1832).'
      },
      { 
        heading: 'Early Education', 
        text: 'Shaykh Muhammad al-Hafiz began his Islamic education with the Qur\'an, and memorized the entire Holy Book by the age of seven. This early mastery of the Qur\'an laid the foundation for his later scholarly achievements.',
        frenchText: 'Shaykh Muhammad al-Hafiz a commencé son éducation islamique avec le Coran, et a mémorisé tout le Livre Saint à l\'âge de sept ans. Cette maîtrise précoce du Coran a jeté les bases de ses réalisations savantes ultérieures.',
        arabicText: 'بدأ شيخ محمد الحافظ تعليمه الإسلامي بالقرآن، وحفظ الكتاب المقدس كاملاً في سن السابعة. هذه الإتقان المبكر للقرآن وضع الأساس لإنجازاته العلمية اللاحقة.',
        hausaText: 'Shaykh Muhammad al-Hafiz ya fara iliminsa na Musulunci da Alkur\'ani, kuma ya haddace dukkan Littafi Mai Tsarki yana da shekara bakwai. Wannan ƙwarewar farko ta Alkur\'ani ta kafa tushe ga nasarorin iliminsa na baya.'
      },
      { 
        heading: 'Studies with Grandmother', 
        ...
        frenchText: 'Suite à la mort de son grand-père, il a continué ses études en jurisprudence (fiqh) avec sa grand-mère – elle-même une érudite qui lui a enseigné l\'Alfiyya d\'Ibn Malik, la Risala d\'Ibn Abi Zayd et le Mukhtasar de Sidi Khalil. Cela démontre le haut niveau d\'éducation islamique parmi les femmes de sa famille.',
        arabicText: 'بعد وفاة جده، واصل دراسته في الفقه مع جدته – التي كانت نفسها عالمة تعلمه ألفية ابن مالك، ورسالة ابن أبي زيد ومختصر سيدي خليل. هذا يوضح المستوى العالي من التعليم الإسلامي بين النساء في عائلته.',
        hausaText: 'Bayan mutuwar kakansa, ya ci gaba da karatunsa na shari\'a (fiqh) tare da kakarsa – ita kanta malami ce wacce ta koya masa Alfiyya na Ibn Malik, Risala na Ibn Abi Zayd da Mukhtasar na Sidi Khalil. Wannan yana nuna babban matakin ilimin Musulunci a tsakanin mata a cikin danginsa.'
      },
      { 
        heading: 'Studies with Abd Allah b. Ahmaddan', 
        text: 'After the death of his grandmother, he traveled to study grammar (nahw) among other sciences with the learned Faqih, Abd Allah b. Ahmaddan (d. 1815). Sidi Ahmaddan was also a shaykh of the Shadhiliyya Nasiriyya, but there is no evidence that Sidi al-Hafiz took the Shadhili wird at this time.',
        frenchText: 'Après la mort de sa grand-mère, il a voyagé pour étudier la grammaire (nahw) parmi d\'autres sciences avec le Faqih érudit, Abd Allah b. Ahmaddan (d. 1815). Sidi Ahmaddan était également un shaykh de la Shadhiliyya Nasiriyya, mais il n\'y a aucune preuve que Sidi al-Hafiz ait pris le wird Shadhili à cette époque.',
      ...
      { 
        ...
        text: 'The companions of Shaykh Tijani in Fes remarked that even after his submission to Shaykh Tijani, Sidi al-Hafiz maintained the utmost respect for his previous teachers; and for Sidi Abd Allah in particular. This demonstrates his character and adherence to Islamic etiquette.',
        frenchText: 'Les compagnons de Shaykh Tijani à Fes ont remarqué que même après sa soumission à Shaykh Tijani, Sidi al-Hafiz a maintenu le plus grand respect pour ses anciens professeurs ; et pour Sidi Abd Allah en particulier. Cela démontre son caractère et son adhésion à l\'étiquette islamique.',
        arabicText: 'لاحظ رفقاء شيخ التجاني في فاس أنه حتى بعد خضوعه لشيخ التجاني، حافظ سيدي الحافظ على أقصى درجات الاحترام لمعلميه السابقين؛ ولسيدي عبد الله على وجه الخصوص. هذا يوضح شخصيته والتزامه بآداب الإسلام.',
        hausaText: 'Abokan Shaykh Tijani a Fes sun lura cewa ko da bayan mika wuya ga Shaykh Tijani, Sidi al-Hafiz ya ci gaba da nuna matuƙar girmamawa ga malamansa na baya; musamman ga Sidi Abd Allah. Wannan yana nuna halinsa da bin ka\'idojin Musulunci.'
      },
      { 
        heading: 'Journey to Fes', 
        text: 'Indeed, it was following Sidi Abd Allah\'s example that Sidi al-Hafiz embarked on his journey seeking knowledge in Fes. But there was also a more immediate reason for his journey to Fes.',
        frenchText: 'En effet, c\'était en suivant l\'exemple de Sidi Abd Allah que Sidi al-Hafiz s\'est lancé dans son voyage à la recherche de connaissances à Fes. Mais il y avait aussi une raison plus immédiate pour son voyage à Fes.',
      ...
      { 
        heading: 'Meeting Shaykh Ahmad Tijani', 
        text: 'After learning the identity of this mysterious Shaykh from a group of Moroccan pilgrims, Sidi al-Hafiz traveled to Fes to meet him. He spent four years with Shaykh Tijani in Fes, from 1800-1804/5. The ijaza he received, still preserved among his descendents in Mauritania, was dictated by Shaykh Tijani and written in the hand of Muhammad b. Mishry, the close companion of Shaykh Tijani and author of Kitab al-Jami\'.',
        frenchText: 'Après avoir appris l\'identité de ce Shaykh mystérieux d\'un groupe de pèlerins marocains, Sidi al-Hafiz a voyagé à Fes pour le rencontrer. Il a passé quatre ans avec Shaykh Tijani à Fes, de 1800-1804/5. L\'ijaza qu\'il a reçue, encore préservée parmi ses descendants en Mauritanie, a été dictée par Shaykh Tijani et écrite de la main de Muhammad b. Mishry, le compagnon proche de Shaykh Tijani et auteur de Kitab al-Jami\'.',
        arabicText: 'بعد أن تعلم هوية هذا الشيخ الغامض من مجموعة من الحجاج المغاربة، سافر سيدي الحافظ إلى فاس لمقابلته. قضى أربع سنوات مع شيخ التجاني في فاس، من 1800-1804/5. الإجازة التي تلقاها، المحفوظة حتى الآن بين أحفاده في موريتانيا، كانت مملوكة من شيخ التجاني ومكتوبة بخط محمد بن مشري، الرفيق المقرب لشيخ التجاني ومؤلف كتاب الجامع.',
        hausaText: 'Bayan ya san ainihin wannan Shaykh mai ban mamaki daga gungun mahajjata na Morocco, Sidi al-Hafiz ya yi tafiya zuwa Fes don ya sadu da shi. Ya shafe shekaru hudu tare da Shaykh Tijani a Fes, daga 1800-1804/5. Ijazar da ya karɓa, har yanzu ana adana ta a tsakanin zuriyarsa a Mauritania, Shaykh Tijani ne ya ba da umarnin rubuta ta kuma Muhammad b. Mishry, abokin kusancin Shaykh Tijani kuma marubucin Kitab al-Jami\' ne ya rubuta ta.'
      },
      { 
        heading: 'Shaykh Tijani\'s Advice', 
        text: 'Before leaving to return home, Shaykh Tijani advised him, "Do not seek to appear (before the people) until Allah makes you appear." This advice reflects the principle of spiritual humility and divine timing in the Sufi tradition.',
        frenchText: 'Avant de partir pour rentrer chez lui, Shaykh Tijani lui a conseillé : "Ne cherche pas à apparaître (devant les gens) jusqu\'à ce qu\'Allah te fasse apparaître." Ce conseil reflète le principe d\'humilité spirituelle et de timing divin dans la tradition soufie.',
      ...
      { 
        heading: 'Divine Sign', 
        text: 'Then he received a surprise visit from an ascetic famous for his visionary encounters with Khidr, the mystical instructor of Moses as mentioned in the Qur\'an. The ascetic told him to give him the wird he was hiding. With this sign, Sidi al-Hafiz began to speak openly of the Tariqa Tijaniyya.',
        frenchText: 'Puis il a reçu une visite surprise d\'un ascète célèbre pour ses rencontres visionnaires avec Khidr, l\'instructeur mystique de Moïse comme mentionné dans le Coran. L\'ascète lui a dit de lui donner le wird qu\'il cachait. Avec ce signe, Sidi al-Hafiz a commencé à parler ouvertement de la Tariqa Tijaniyya.',
        arabicText: 'ثم تلقى زيارة مفاجئة من زاهد مشهور بلقاءاته الرؤيوية مع الخضر، المعلم الصوفي لموسى كما ذكر في القرآن. قال له الزاهد أن يعطيه الورد الذي كان يخفيه. بهذه العلامة، بدأ سيدي الحافظ يتحدث علناً عن الطريقة التجانية.',
        hausaText: 'Daga baya ya karɓi ziyara mai ban mamaki daga wani mai zuhudu da aka fi sani da saduwar sa da Khidr, malamin ruhaniya na Musa kamar yadda aka ambata a cikin Alkur\'ani. Mai zuhudu ya ce masa ya ba shi wird da yake ɓoye. Da wannan alamar, Sidi al-Hafiz ya fara magana a fili game da Tariqa Tijaniyya.'
      },
      { 
        heading: 'Teaching & Scholarship', 
        text: 'His teachings attracted a great many students and, besides his credentials as a Sufi shaykh, he was particularly renowned as a distinguished scholar of hadith, possessing a highly desirable chain (isnad) of transmission through Salih al-Fulani in Medina.',
        frenchText: 'Ses enseignements ont attiré un grand nombre d\'étudiants et, outre ses références en tant que shaykh soufi, il était particulièrement réputé comme un érudit distingué du hadith, possédant une chaîne de transmission (isnad) très désirable à travers Salih al-Fulani à Médine.',
      ...
      { 
        heading: 'Tolerance & Respect', 
        text: 'Sidi al-Hafiz discouraged conflict between Sufi orders and advised his disciples not to disrespect the followers of other Sufi paths, saying "Do not ask him who follows another Sufi order to abandon his litany and do not seek to dampen his enthusiasm for it. Tell him instead that all the litanies (awrad) are paths that lead to Allah."',
        frenchText: 'Sidi al-Hafiz a découragé les conflits entre les ordres soufis et a conseillé à ses disciples de ne pas manquer de respect aux adeptes d\'autres voies soufies, disant : "Ne demandez pas à celui qui suit un autre ordre soufi d\'abandonner sa litanie et ne cherchez pas à décourager son enthousiasme pour elle. Dites-lui plutôt que toutes les litanies (awrad) sont des chemins qui mènent à Allah."',
        arabicText: 'ثبط سيدي الحافظ النزاع بين الطرق الصوفية ونصح تلاميذه بعدم عدم احترام أتباع الطرق الصوفية الأخرى، قائلاً: "لا تسأل من يتبع طريقة صوفية أخرى أن يتخلى عن أوراده ولا تسع لإضعاف حماسه لها. قل له بدلاً من ذلك أن جميع الأوراد طرق تؤدي إلى الله."',
        hausaText: 'Sidi al-Hafiz ya hana rikici tsakanin ƙungiyoyin Sufi kuma ya ba almajiransa shawara kada su raina mabiyan wasu hanyoyin Sufi, yana cewa: "Kada ka tambayi wanda ya bi wata ƙungiyar Sufi ya bar awradinsa kuma kada ka nemi ka rage sha\'awarsa gare ta. A maimakon haka, ka ce masa cewa dukkan awrad hanyoyi ne da suke kaiwa ga Allah."'
      },
      { 
        heading: 'Innovation in Sufi Practice', 
        text: 'Following the advice of Shaykh Tijani, Sidi al-Hafiz\'s own Sufi instruction differed from existing Sufi practice in Mauritania by its absence of khalwa and a de-emphasis of talismanic sciences. This represented a new approach to Sufi practice in the region.',
        frenchText: 'Suivant les conseils de Shaykh Tijani, l\'instruction soufie de Sidi al-Hafiz différait de la pratique soufie existante en Mauritanie par l\'absence de khalwa et une dé-emphase des sciences talismaniques. Cela représentait une nouvelle approche de la pratique soufie dans la région.',
      ...
      { 
        heading: 'Hafiziyya Legacy', 
        text: 'The book of Ubayda ibn Muhammad al-Saghir al-Tashit, Mizab al-Rahma al-Rabbaniyya fi al-Tarbiya bi al-Tariqa al-Tijaniyya (1851), is considered a masterful synthesis of the Tijani legacy left by Muhammad al-Hafiz. It describes the essence of the Tariqa as gratitude (shukr) to Allah and details a methodology of spiritual training (tarbiya) through the three stages of Islam (submission), Iman (faith) and Ihsan (spiritual excellence).',
        frenchText: 'Le livre d\'Ubayda ibn Muhammad al-Saghir al-Tashit, Mizab al-Rahma al-Rabbaniyya fi al-Tarbiya bi al-Tariqa al-Tijaniyya (1851), est considéré comme une synthèse magistrale de l\'héritage Tijani laissé par Muhammad al-Hafiz. Il décrit l\'essence de la Tariqa comme la gratitude (shukr) envers Allah et détaille une méthodologie de formation spirituelle (tarbiya) à travers les trois étapes de l\'Islam (soumission), Iman (foi) et Ihsan (excellence spirituelle).',
        arabicText: 'كتاب عبيدة بن محمد الصغير التاشيت، ميزاب الرحمة الربانية في التربية بالطريقة التجانية (1851)، يعتبر تركيباً بارعاً للإرث التجاني الذي تركه محمد الحافظ. يصف جوهر الطريقة كشكر لله ويوضح منهجية التدريب الروحي (التربية) من خلال المراحل الثلاث للإسلام (الخضوع)، الإيمان (الإيمان) والإحسان (التميز الروحي).',
        hausaText: 'Littafin Ubayda ibn Muhammad al-Saghir al-Tashit, Mizab al-Rahma al-Rabbaniyya fi al-Tarbiya bi al-Tariqa al-Tijaniyya (1851), ana ɗaukarsa a matsayin haɗin kai mai ƙwarewa na gadon Tijani da Muhammad al-Hafiz ya bari. Ya bayyana ainihin Tariqa a matsayin godiya (shukr) ga Allah kuma ya ƙayyade hanyar horar da ruhaniya (tarbiya) ta hanyar matakai uku na Musulunci (mika wuya), Iman (imani) da Ihsan (kyakkyawan ruhaniya).'
      },
      { 
        heading: 'Mawlud Fal', 
        text: 'The most famous disciple of Muhammad al-Hafiz was Mawlud Fal, who is credited with the expansion of al-Hafiz\'s teachings outside of the Idaw \'Ali. Mawlud Fal was from the Id-Ayqub, a people of Mauritania famous for their expertise in jurisprudence.',
        frenchText: 'Le disciple le plus célèbre de Muhammad al-Hafiz était Mawlud Fal, qui est crédité de l\'expansion des enseignements d\'al-Hafiz en dehors des Idaw \'Ali. Mawlud Fal était des Id-Ayqub, un peuple de Mauritanie célèbre pour son expertise en jurisprudence.',
        arabicText: 'كان أشهر تلميذ لمحمد الحافظ هو مولود فال، الذي يُنسب إليه توسيع تعاليم الحافظ خارج إداو علي. كان مولود فال من إد-أيوب، شعب من موريتانيا مشهور بخبرته في الفقه.',
        hausaText: 'Mafi shahararren almajirin Muhammad al-Hafiz shi ne Mawlud Fal, wanda ake ba shi laifi da faɗaɗa koyarwar al-Hafiz a wajen Idaw \'Ali. Mawlud Fal ya fito daga Id-Ayqub, mutanen Mauritania da aka fi sani da ƙwarewarsu a fannin shari\'a.'
      },
      { 
        heading: 'Mawlud Fal\'s Journey', 
        text: 'He became a close disciple of Shaykh al-Hafiz and eventually married his sister. He left for Fes in 1815 hoping to meet Shaykh Tijani in person, but arrived just after his passing. The Tijani notables of Fes nonetheless renewed his ijaza originally given him by al-Hafiz.',
        frenchText: 'Il est devenu un disciple proche de Shaykh al-Hafiz et a finalement épousé sa sœur. Il est parti pour Fes en 1815 espérant rencontrer Shaykh Tijani en personne, mais est arrivé juste après son décès. Les notables Tijani de Fes ont néanmoins renouvelé son ijaza qui lui avait été donné à l\'origine par al-Hafiz.',
        arabicText: 'أصبح تلميذاً مقرباً لشيخ الحافظ وتزوج أخيراً أخته. غادر إلى فاس في 1815 آملاً في لقاء شيخ التجاني شخصياً، لكنه وصل بعد وفاته مباشرة. ومع ذلك، جدد أعيان التجاني في فاس إجازته التي كان قد منحها له الحافظ في الأصل.',
        hausaText: 'Ya zama almajiri na kusa na Shaykh al-Hafiz kuma daga ƙarshe ya auri \'yar\'uwarsa. Ya tafi Fes a 1815 yana fatan saduwa da Shaykh Tijani da kansa, amma ya isa jim kaɗan bayan mutuwarsa. Duk da haka, fitattun mutanen Tijani na Fes sun sabunta ijazarsa da al-Hafiz ya ba shi a asali.'
      },
      { 
        heading: 'Mawlud Fal\'s Studies in Fes', 
        text: 'He studied closely with the son of Ali Harazim, who instructed him in the practice of khalwa and other supererogatory litanies not transmitted to him by Muhammad al-Hafiz. After his study in Fes, Mawlud Fal traveled widely throughout West Africa.',
        frenchText: 'Il a étudié de près avec le fils d\'Ali Harazim, qui l\'a instruit dans la pratique de la khalwa et d\'autres litanies surérogatoires qui ne lui avaient pas été transmises par Muhammad al-Hafiz. Après ses études à Fes, Mawlud Fal a voyagé largement à travers l\'Afrique de l\'Ouest.',
        arabicText: 'درس عن كثب مع ابن علي حرازم، الذي علمه ممارسة الخلوة والوردات النافلة الأخرى التي لم تنقل إليه من محمد الحافظ. بعد دراسته في فاس، سافر مولود فال على نطاق واسع في جميع أنحاء غرب أفريقيا.',
        hausaText: 'Ya yi karatu sosai tare da ɗan Ali Harazim, wanda ya koya masa aikin khalwa da sauran addu\'o\'in da ba a ba shi ba daga Muhammad al-Hafiz. Bayan karatunsa a Fes, Mawlud Fal ya yi tafiya sosai a ko\'ina cikin Yammacin Afirka.'
      },
      { 
        heading: 'Expansion Through Mawlud Fal', 
        text: 'During his travels, Mawlud Fal appointed many teachers who themselves helped spread the Tariqa all over Africa. Thus \'Abd al-Karim b. Ahmad al-Naqil (the first shaykh of al-Hajj Umar Futi) became one of his important muqaddams in Futa Jallon; Mudibu Ahmad Raji received an ijaza from Mawlud Fal to spread the Tariqa in Northern Nigeria; and Wad Dulayb spread the Tariqa in the Sudan under the silsilah of Mawluf Fal.',
        frenchText: 'Au cours de ses voyages, Mawlud Fal a nommé de nombreux enseignants qui ont eux-mêmes aidé à répandre la Tariqa dans toute l\'Afrique. Ainsi, \'Abd al-Karim b. Ahmad al-Naqil (le premier shaykh d\'al-Hajj Umar Futi) est devenu l\'un de ses muqaddams importants au Futa Jallon ; Mudibu Ahmad Raji a reçu une ijaza de Mawlud Fal pour répandre la Tariqa dans le nord du Nigeria ; et Wad Dulayb a répandu la Tariqa au Soudan sous la silsilah de Mawlud Fal.',
        arabicText: 'خلال رحلاته، عين مولود فال العديد من المعلمين الذين ساعدوا بدورهم في نشر الطريقة في جميع أنحاء أفريقيا. وهكذا أصبح عبد الكريم بن أحمد الناقل (أول شيخ للحاج عمر فوتي) أحد مقدميه المهمين في فوتا جالون؛ تلقى موديبو أحمد راجي إجازة من مولود فال لنشر الطريقة في شمال نيجيريا؛ ونشر ود دلييب الطريقة في السودان تحت سلسلة مولود فال.',
        hausaText: 'A lokacin tafiye-tafiyensa, Mawlud Fal ya naɗa malamai da yawa waɗanda su kansu suka taimaka wajen yada Tariqa a ko\'ina cikin Afirka. Don haka \'Abd al-Karim b. Ahmad al-Naqil (shugaban farko na al-Hajj Umar Futi) ya zama ɗaya daga cikin muqaddamansa masu mahimmanci a Futa Jallon; Mudibu Ahmad Raji ya karɓi ijaza daga Mawlud Fal don yada Tariqa a Arewacin Najeriya; kuma Wad Dulayb ya yada Tariqa a Sudan a ƙarƙashin silsilah na Mawlud Fal.'
      },
      { 
        heading: 'Support for Al-Hajj Umar\'s Jihad', 
        text: 'The "Hafiziyya" branch of the Tijaniyya also played an important role in securing support for the Jihad of al-Hajj Umar among the Moroccan Tijani scholars. Al-Hajj Umar kept in close contact with the Hafiziyya zawiya in Mauritania even after his training with Muhammad al-Ghali.',
        frenchText: 'La branche "Hafiziyya" de la Tijaniyya a également joué un rôle important dans l\'obtention du soutien pour le Jihad d\'al-Hajj Umar parmi les érudits Tijani marocains. Al-Hajj Umar a maintenu un contact étroit avec la zawiya Hafiziyya en Mauritanie même après sa formation avec Muhammad al-Ghali.',
        arabicText: 'لعب فرع "الحافظية" من التجانية أيضاً دوراً مهماً في تأمين الدعم لجهاد الحاج عمر بين علماء التجاني المغاربة. حافظ الحاج عمر على اتصال وثيق مع زاوية الحافظية في موريتانيا حتى بعد تدريبه مع محمد الغالي.',
        hausaText: 'Reshen "Hafiziyya" na Tijaniyya shima ya taka muhimmiyar rawa wajen samun goyon baya ga Jihad na al-Hajj Umar a tsakanin malaman Tijani na Maroko. Al-Hajj Umar ya ci gaba da kasancewa da hulɗa ta kusa da zawiyar Hafiziyya a Mauritania har ma bayan horonsa da Muhammad al-Ghali.'
      },
      { 
        heading: 'Connection to Sokoto', 
        text: 'Once, when the Sokoto Sultan Muhammad Bello requested permission from him for the prayer hizb al-bahr and the book Jawahir al-Khams, al-Hajj Umar responded that he himself could not give such permission, but that he would request it from the Hafiziyya zawiya in Mauritania. To this end, al-Hajj Umar sent his elder brother Alfa Ahmad, who had his own ijaza renewed by the Hafiziyya zawiya.',
        frenchText: 'Une fois, lorsque le Sultan de Sokoto Muhammad Bello lui a demandé la permission pour la prière hizb al-bahr et le livre Jawahir al-Khams, al-Hajj Umar a répondu qu\'il ne pouvait pas lui-même donner une telle permission, mais qu\'il la demanderait à la zawiya Hafiziyya en Mauritanie. À cette fin, al-Hajj Umar a envoyé son frère aîné Alfa Ahmad, qui a eu sa propre ijaza renouvelée par la zawiya Hafiziyya.',
        arabicText: 'ذات مرة، عندما طلب سلطان سوكوتو محمد بيلو منه الإذن لصلاة حزب البحر وكتاب جوهر الخمس، رد الحاج عمر أنه لا يستطيع هو نفسه منح مثل هذا الإذن، لكنه سيطلبه من زاوية الحافظية في موريتانيا. لهذا الغرض، أرسل الحاج عمر أخاه الأكبر ألفا أحمد، الذي تم تجديد إجازته الخاصة من قبل زاوية الحافظية.',
        hausaText: 'Wani lokaci, lokacin da Sarkin Sokoto Muhammad Bello ya nemi izini daga gare shi don addu\'ar hizb al-bahr da littafin Jawahir al-Khams, al-Hajj Umar ya amsa cewa shi da kansa ba zai iya ba da irin wannan izini ba, amma zai nemi shi daga zawiyar Hafiziyya a Mauritania. Don wannan dalili, al-Hajj Umar ya aika babban ɗan\'uwansa Alfa Ahmad, wanda aka sabunta ijazarsa ta musamman daga zawiyar Hafiziyya.'
      },
      { 
        heading: 'Twentieth Century Influence', 
        text: 'Even in the twentieth century, the Hafiziyya tradition played a large role in shaping the careers of Tijani scholars. One of al-Hajj Malik Sy\'s most important initiations into the Tariqa was through the son of Mawlud Fal, known as al-Shaykh.',
        frenchText: 'Même au vingtième siècle, la tradition Hafiziyya a joué un rôle important dans la formation des carrières des érudits Tijani. L\'une des initiations les plus importantes d\'al-Hajj Malik Sy dans la Tariqa s\'est faite par le fils de Mawlud Fal, connu sous le nom d\'al-Shaykh.',
        arabicText: 'حتى في القرن العشرين، لعبت تقاليد الحافظية دوراً كبيراً في تشكيل مسارات علماء التجاني. كانت إحدى أهم بدايات الحاج مالك سي في الطريقة من خلال ابن مولود فال، المعروف بالشيخ.',
        hausaText: 'Har ma a ƙarni na ashirin, al\'adar Hafiziyya ta taka babbar rawa wajen tsara ayyukan malaman Tijani. Ɗaya daga cikin mahimman farkon al-Hajj Malik Sy a cikin Tariqa ya kasance ta hanyar ɗan Mawlud Fal, wanda aka fi sani da al-Shaykh.'
      },
      { 
        heading: 'Connection to Shaykh Ibrahim Niasse', 
        text: 'Shaykh Ibrahim Niasse\'s most significant early ijaza besides that from his father was from al-Hajj Abdullahi Wuld al-Hajj, a renowned representative of the Hafiziyya tradition who had been seeking the spiritual flood (fayda) of Shaykh Ahmad Tijani for many years before recognizing it in the person of Shaykh Ibrahim Niasse.',
        frenchText: 'L\'ijaza la plus significative de Shaykh Ibrahim Niasse au début, en plus de celle de son père, était d\'al-Hajj Abdullahi Wuld al-Hajj, un représentant renommé de la tradition Hafiziyya qui avait cherché l\'inondation spirituelle (fayda) de Shaykh Ahmad Tijani pendant de nombreuses années avant de la reconnaître en la personne de Shaykh Ibrahim Niasse.',
        arabicText: 'كانت أهم إجازة مبكرة لشيخ إبراهيم نياس، بالإضافة إلى إجازة والده، من الحاج عبد الله ولد الحاج، ممثل مشهور لتقليد الحافظية الذي كان يبحث عن الفيضة الروحية لشيخ أحمد التجاني لسنوات عديدة قبل أن يعترف بها في شخص شيخ إبراهيم نياس.',
        hausaText: 'Mafi muhimman ijaza na farko na Shaykh Ibrahim Niasse, ban da na mahaifinsa, ya kasance daga al-Hajj Abdullahi Wuld al-Hajj, wakilin Hafiziyya da aka fi sani da shi wanda ya kasance yana neman ambaliyar ruhaniya (fayda) na Shaykh Ahmad Tijani na shekaru da yawa kafin ya gane ta a cikin mutumin Shaykh Ibrahim Niasse.'
      },
      { 
        heading: 'Legacy & Continuing Influence', 
        text: 'As the first introducer of the Tariqa Tijaniyya in Mauritania and the founder of the Hafiziyya tradition, Sidi Muhammad al-Hafiz al-Shinqiti\'s influence continues to be felt throughout West Africa. His scholarly excellence, spiritual depth, and commitment to spreading the Tariqa established a foundation that has endured for centuries.',
        frenchText: 'En tant que premier introducteur de la Tariqa Tijaniyya en Mauritanie et fondateur de la tradition Hafiziyya, l\'influence de Sidi Muhammad al-Hafiz al-Shinqiti continue d\'être ressentie dans toute l\'Afrique de l\'Ouest. Son excellence savante, sa profondeur spirituelle et son engagement à répandre la Tariqa ont établi une fondation qui a duré des siècles.',
        arabicText: 'بصفته أول من أدخل الطريقة التجانية في موريتانيا ومؤسس تقليد الحافظية، يستمر تأثير سيدي محمد الحافظ الشنقيطي في الشعور به في جميع أنحاء غرب أفريقيا. امتيازه العلمي وعمقه الروحي والتزامه بنشر الطريقة أسسوا أساساً دام لقرون.',
        hausaText: 'A matsayinsa na farkon mai gabatar da Tariqa Tijaniyya a Mauritania kuma wanda ya kafa al\'adar Hafiziyya, tasirin Sidi Muhammad al-Hafiz al-Shinqiti ya ci gaba da kasancewa a ko\'ina cikin Yammacin Afirka. Ƙwararriyarsa ta ilimi, zurfinsa na ruhaniya da sadaukarwarsa wajen yada Tariqa sun kafa tushe wanda ya dore tsawon ƙarni.'
      }
    ],
  },
  // 7. Umar Futi
