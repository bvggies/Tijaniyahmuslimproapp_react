...
const SCHOLARS: Scholar[] = [
  // 1. Sheikh Ahmad Tijani
  {
    ...
    details: [
      ...
      { heading: 'Distinguished Teachers in Fes', text: 'Among his teachers in Fes were many famous for their knowledge and saintliness: Al-Tayyib b. Muhammad al-Sharif of Wazan (d. 1180/1767), head of the Wazzaniyya Sufi order; Sidi Abdullah b. \'Arabi al-Mada\'u (d. 1188); Sidi Ahmad al-Tawash (d. 1204); Sidi Ahmad al-Yemeni; Abu Abdullah Sidi Muhammad al-Tizani; and Abu Abbas Ahmad al-Habib al-Sijilmasy (d. 1165).' },
      { heading: 'Sufi Orders in Fes', text: 'From Sidi Ahmad al-Yemeni, Shaykh Tijani took the Qadariyya Sufi order, and from Abu Abdullah Sidi Muhammad al-Tizani he took the Nasiriyya order. He also took the order of Abu Abbas Ahmad al-Habib al-Sijilmasy, who came to him in a dream, put his mouth on his, and taught him a secret name.' },
      { heading: 'Spiritual Prediction by al-Wanjili', text: 'Sidi Muhammad al-Wanjili (d. 1185), a man known for his saintliness, predicted for him a maqam (spiritual station) of Qutbaniyya (Polehood) similar to that of Abu Hasan al-Shadhili, but that his fath (spiritual opening) would come in the desert. This prediction would later prove accurate.' },
      { heading: 'Desert Journey & Asceticism', text: 'Shaykh Tijani spent time in the desert Zawiya of the famous Qutb Sidi Abd al-Qadir b. Muhammad al-Abyad (known as Sidi al-Shaykh) before returning to Ain Madi, then moving on to Tlemcen. His activities consisted of teaching Qur\'anic exegesis (tafsir) and Hadith while continuing rigorous practice of asceticism, including frequent fasting and supererogatory worship.' },
      { heading: 'Journey to Mecca & Hajj', text: 'In 1186/1773, Shaykh Ahmad Tijani set out to accomplish the Islamic pilgrimage (Hajj). His first stop of note was at Algiers, where he met Sidi Muhammad b. Abd al-Rahman al-Azhary (d. 1793), a prominent muqaddam of the Khalwatiyya Sufi order who had received initiation at the hands of Shaykh al-Azhar Muhammad al-Hifni.' },
      { heading: 'Khalwatiyya Initiation', text: 'Shaykh Tijani\'s affiliation with the Khalwatiyya order was perhaps the most significant influence upon his thought prior to his waking meetings with the Prophet. He received initiation at the hands of al-Azhary in Algiers before continuing his journey East. This connection would later influence his spiritual development.' },
      { heading: 'Tunis & Zaytuna University', text: 'Shaykh Ahmad Tijani\'s journey brought him to Tunis, home of the famous Zaytuna mosque and university. Upon his entry, he immediately met with people of saintly renown, such as Sidi Abd al-Samad al-Ruhwij, and took up teaching at Zaytuna, including Ibn \'Atta Allah\'s Kitab al-hikam.' },
      { heading: 'Mecca & Hajj Performance', text: 'Arriving in Mecca just after Ramadan in the year 1187/1774, Shaykh Ahmad Tijani stayed long enough to accomplish the rites of the Hajj. During his stay, he sought out people of "goodness, piety, righteousness and happiness" and engaged in spiritual practices.' },
      { heading: 'Meeting with Ahmad al-Hindi', text: 'His search led him to a mysterious saint from India, Ahmad b. Abdullah al-Hindi, who had made a vow to speak to no one except his servant. Al-Hindi sent him the message, "You are the inheritor of my knowledge, secrets, gifts and lights," and informed him to visit the Qutb Muhammad al-Samman when in Medina.' },
      { heading: 'Medina & Prophet\'s Tomb', text: 'After accomplishing the ziyara (visitation) to the Prophet\'s tomb, where "God completed his aspiration and longing" to greet the Prophet, Shaykh Tijani went to visit the renowned Shaykh Muhammad Abd al-Karim al-Samman (d. 1189/1775).' },
      { heading: 'Meeting with al-Samman', text: 'Al-Samman was a member of the Khalwatiyya order, being one of two students given full ijaza (permission) by Mustafa al-Bakri. Before Shaykh Tijani\'s departure, al-Samman informed him of certain secret "names" and told him that he was to be the al-qutb al-jami\' (the comprehensive Pole).' },
      { heading: 'Return via Cairo', text: 'On his return from the Hijaz, Shaykh Tijani stopped in Cairo and visited Mahmud al-Kurdi, the Khalwati representative in Egypt. Demonstrating his profound respect for his teachers of the Khalwati tradition, Tijani accepted from al-Kurdi to be a muqaddam (propagator) of the Khalwati order in North Africa.' },
      { heading: 'The Prophet\'s Appearance in Abi Samghun', text: 'The beginning of a distinctive "Tijani" order can be located with the appearance of the Prophet Muhammad to Shaykh Ahmad Tijani in a waking vision. This occurred in 1784, in the desert oasis of Abi Samghun. The Prophet informed him that he himself was his initiator on the Path and told him to leave the shaykhs he had previously followed.' },
      { heading: 'The New Wird & Permission', text: 'The Shaykh then received the basis of a new wird and was given permission to give "spiritual training to the creation in [both] the general and unlimited (itlaq)." The Prophet told him: "You are not indebted for any favor from the shaykhs of the Path, for I am your means (wasita) and your support in the [spiritual] realization, so leave the entirety of what you have taken from all the tariqas."' },
      { heading: 'Establishment in Fes', text: 'Shaykh Ahmad Tijani and a group of his closest companions took up residence in Fes beginning in 1213/1798. By the time of his arrival, his fame as a scholar possessing religious charisma or blessing (baraka) had spread throughout the Maghreb.' },
      { heading: 'Relationship with Sultan Mawlay Sulayman', text: 'The Shaykh was met by a delegation of scholars selected by the Sultan. After a series of tests to ascertain the veracity of Tijani\'s claims to sainthood, Mawlay Sulayman became closely linked to the newcomer, appointing him to his council of religious scholars and giving him a large house ("the House of Mirrors").' },
      ...
      { heading: 'The Seal of Muhammadan Sainthood', text: 'Shaykh Ahmad Tijani is recognized by Tijanis as the Khātam al-Wilāyah al-Muhammadiyyah (Seal of Muhammadan Sainthood), meaning that none will appear in that rank in the complete way that he appeared. He is the Seal of the complete manifestation of that rank.' },
      { heading: 'Passing & Legacy', text: 'Shaykh Ahmad Tijani passed from this world in 1230 AH (1815) at the age of eighty. He left behind him a firmly established order, the Tariqa Muhammadiyya emphasis of which inspired many of his later followers to renew and spread Islam in diverse communities far from the mother zawiya in Fes.' },
      { heading: 'Burial & Continuing Influence', text: 'Shaykh Ahmad Tijani was buried in his zawiya in Fes, which today remains a center of congregation for Tijanis around the world. His order has become the most widespread Sufi order in West Africa and continues to inspire millions of followers worldwide, maintaining its spiritual vitality and scholarly tradition.' }
    ],
  },
  // 2. Sidi Ali Harazim Al-Barada
  {
    ...
    details: [
      ...
      { heading: 'First Meeting in Wajda', text: 'Sidi Ali first met Shaykh Tijani in Wajda (or Oujda, Eastern Morocco) while the latter was en route to Fes after returning from Hajj. Both had received knowledge from God that he was to be associated with the other, but Sidi Ali did not immediately recognize Shaykh Tijani until the Shaykh said, "You have been told that your shaykh on the path will be a certain Shaykh Ahmad Tijani."' },
      { heading: 'Recognition & Initiation', text: 'Much surprised at the stranger\'s ability to guess the content of his previous dreams, Sidi Ali replied, "Yes, that is so." Shaykh Tijani then said, "I am he." At this time Shaykh Tijani had not yet received his own Tariqa Muhammadiyya from the Prophet, so Shaykh Tijani instructed him in the Khalwati way.' },
      ...
      { heading: 'Jawahir al-Ma\'ani - The Masterpiece', text: 'Of this book, the Prophet told Shaykh Tijani, "This book belongs to me"; and concerning the words of Sidi Ali more generally, the Shaykh used to say, "What my khalifa says, I also say that." The Jawahir al-Ma\'ani is considered the most authoritative source on the life and teachings of Shaykh Ahmad Tijani.' },
      { heading: 'Spiritual Authority & Succession', text: 'He is similarly reported to have said of Sidi Ali, "No one will receive anything from me except by way of Sidi Harazim." Although he died before Shaykh Tijani, Sidi Ali is still considered the greatest spiritual successor among the Shaykh\'s companions, even if the greatest successor alive at Shaykh Tijani\'s own passing was Sidi Ali Tamasini.' },
      { heading: 'Greater Illumination (Fath al-Akbar)', text: 'After receiving the greater illumination (fath al-akbar), the Shaykh sent Sidi Ali Harazim to accomplish his pilgrimage to Mecca and to visit the Prophet Muhammad in Medina. Many miracles (karamat) and spiritual unveilings are reported on this journey.' },
      { heading: 'Journey to Mecca & Spiritual Impact', text: 'Many miracles (karamat) and spiritual unveilings are reported on this journey, which we are not inclined to mention here. But it is clear his lofty spiritual zeal (himma) touched many who encountered him on this journey, among whom was Shaykh al-Islam Ibrahim Riyahi of the Zaytuna University who hosted Sidi Ali for several months in Tunis.' },
      { heading: 'Meeting with Shaykh Riyahi in Tunis', text: 'Shaykh Riyahi was no doubt inspired from meeting Sidi Ali to visit Shaykh Tijani himself on a later trip to Fes. This meeting had a profound impact on Shaykh Riyahi\'s spiritual development and his eventual embrace of the Tariqa Tijaniyya.' },
      { heading: 'Burial at Badr Among Martyrs', text: 'After accomplishing the Hajj, Sidi Ali went to visit the tomb of the Prophet. When he arrived in Badr on the way to Medina, he was overcome by love for the Prophet and fell into such a deep spiritual state (hal) that he came to be buried among the martyrs at Badr.' },
      { heading: 'Shaykh Tijani\'s Testimony at Burial', text: 'At the exact moment of his burial, Shaykh Tijani told his companions in Fes, "If they did not bury him, they would hear from him sciences, gnosis and secrets such as they have never heard before and have never found in any book." This shows the depth of Sidi Ali\'s spiritual knowledge.' },
  ...
  // 3. Sidi Ali Tamasini
  {
    ...
    details: [
      ...
      { heading: 'Investiture by Shaykh Tijani', text: 'Shaykh Ahmad Tijani invested him with the imama in the grand zawiya in Fes in the presence of many other notable scholars and saints. Once when asked by another disciple to be given permission for a certain prayer mastered by Ali Tamasin, Shaykh Tijani replied, "Is there another like Ali Tamasin?"' },
      { heading: 'Karamat & Miracles', text: 'He was renowned for the karamat (saintly miracles) flowing from his hands. He was a gifted healer and knew certain secrets to travel great distances with one step or to send objects to others. For the open demonstration of these latter two abilities, he was reprimanded by Shaykh Tijani.' },
  ...
  // 4. Sidi Muhammad Ghali
  {
    ...
    details: [
      ...
      { heading: 'Role in West Africa', text: 'He played a crucial role in the spread of the Tariqa Tijaniyya to West Africa, particularly through his relationship with Al-Hajj Umar al-Futi Tal, whom he trained and authorized as a khalifa.' },
  ...
  // 5. Ibrahim Riyahi
  {
    ...
    details: [
      ...
      { heading: 'Education at Zaytuna', text: 'He received his education at the prestigious Zaytuna University in Tunis, where he studied under the leading scholars of his time. He excelled in various Islamic sciences, particularly in Maliki jurisprudence and hadith.' },
